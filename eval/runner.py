...
def main():
    ...
    parser.add_argument("--language", default="hin", help="evaluation language: eng (official English columns), hin, or mar (default: hin)")
    ...
    full_report = {
        "meta": {
            ...
            "language": args.language,
            "source_split_language": "hin" if args.language in {"en", "eng", "english"} else args.language,
            "split": args.split,
            "num_answerable": args.num_answerable,
            "num_unanswerable": args.num_unanswerable,
